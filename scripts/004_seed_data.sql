...
-- Listas de precios
INSERT INTO public.listas_precios (nombre, descripcion, tipo) VALUES
...
-- Deposito principal
INSERT INTO public.depositos (codigo, nombre, direccion) VALUES
('DEP-01', 'Depósito Central', 'Av. Principal 123, San Salvador de Jujuy')
ON CONFLICT (codigo) DO NOTHING;

-- Caja principal
INSERT INTO public.cajas (nombre, tipo, saldo) VALUES
